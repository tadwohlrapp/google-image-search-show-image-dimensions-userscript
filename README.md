...
After you have installed a userscript manager, [click here to install the userscript](https://greasyfork.org/scripts/401432/code/google-image-search-show-image-dimensions.user.js) and visit the Google Image Search page 😃